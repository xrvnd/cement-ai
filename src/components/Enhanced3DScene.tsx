...
import SustainabilityOptimization from './SustainabilityOptimization';
...
// Sustainable Optimization Features Component
const SustainableFeatures: React.FC<{ showDetails: boolean }> = ({ showDetails }) => {
  const [showOptimization, setShowOptimization] = useState(false);
  const [hoveredCard, setHoveredCard] = useState<string | null>(null);
  
  return (
    <>
      {/* Sustainability Optimization Button - Only show when details are visible */}
      {showDetails && (
        <Html position={[0, 15, 0]} center>
          ...
          >
            ...
            <div style={{ fontSize: '10px', opacity: 0.8, marginTop: '2px' }}>
              TSR • Energy • Quality • Cross-Process
            </div>
          </div>
        </Html>
      )}

      {/* Alternative Fuel Storage Visualization - Only show when details are visible */}
      {showDetails && (
        <Html position={[-25, 8, -15]} center>
          <div 
            style={{
              background: hoveredCard === 'alternative-fuels' ? 'rgba(0, 184, 148, 0.2)' : 'rgba(0, 184, 148, 0.1)',
              padding: '8px 12px',
              borderRadius: '8px',
              color: '#00b894',
              fontSize: '12px',
              fontWeight: 'bold',
              border: hoveredCard === 'alternative-fuels' ? '2px solid rgba(0, 184, 148, 0.5)' : '1px solid rgba(0, 184, 148, 0.3)',
              textAlign: 'center',
              minWidth: '120px',
              cursor: 'pointer',
              transition: 'all 0.3s ease',
              transform: hoveredCard === 'alternative-fuels' ? 'scale(1.05)' : 'scale(1)',
              boxShadow: hoveredCard === 'alternative-fuels' ? '0 4px 12px rgba(0, 184, 148, 0.3)' : 'none'
            }}
            onMouseEnter={() => setHoveredCard('alternative-fuels')}
            onMouseLeave={() => setHoveredCard(null)}
          >
            🔥 Alternative Fuels
            <div style={{ fontSize: '10px', opacity: 0.8, marginTop: '2px' }}>
              RDF: 12% | Biomass: 8% | TSR: 22%
            </div>
            {hoveredCard === 'alternative-fuels' && (
              <div style={{
                position: 'absolute',
                top: '100%',
                left: '50%',
                ...
                <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>🔥 Alternative Fuel Optimization</div>
                <div>• RDF Utilization: 12% (Target: 20%)</div>
                <div>• Biomass Integration: 8% (Target: 12%)</div>
                <div>• Plastic Waste: 2% (Target: 3%)</div>
                <div>• Tire Chips: 1% (Target: 1%)</div>
                <div>• TSR: 22% (Target: 35%)</div>
                <div style={{ color: '#00b894', marginTop: '4px' }}>Click to optimize fuel mix</div>
              </div>
            )}
          </div>
        </Html>
      ...
      {/* Energy Efficiency Indicator - Only show when details are visible */}
      {showDetails && (
        <Html position={[25, 8, -15]} center>
          <div 
            style={{
              background: hoveredCard === 'energy-efficiency' ? 'rgba(116, 185, 255, 0.2)' : 'rgba(116, 185, 255, 0.1)',
              padding: '8px 12px',
              borderRadius: '8px',
              color: '#74b9ff',
              fontSize: '12px',
              fontWeight: 'bold',
              border: hoveredCard === 'energy-efficiency' ? '2px solid rgba(116, 185, 255, 0.5)' : '1px solid rgba(116, 185, 255, 0.3)',
              textAlign: 'center',
              minWidth: '120px',
              cursor: 'pointer',
              transition: 'all 0.3s ease',
              transform: hoveredCard === 'energy-efficiency' ? 'scale(1.05)' : 'scale(1)',
              boxShadow: hoveredCard === 'energy-efficiency' ? '0 4px 12px rgba(116, 185, 255, 0.3)' : 'none'
            }}
            onMouseEnter={() => setHoveredCard('energy-efficiency')}
            onMouseLeave={() => setHoveredCard(null)}
          >
            ⚡ Energy Efficiency
            <div style={{ fontSize: '10px', opacity: 0.8, marginTop: '2px' }}>
              Current: 85.2% | Target: 90%
            </div>
            {hoveredCard === 'energy-efficiency' && (
              <div style={{
                position: 'absolute',
                top: '100%',
                left: '50%',
                ...
                <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>⚡ Energy Efficiency Metrics</div>
                <div>• Overall Efficiency: 85.2% (Target: 90%)</div>
                <div>• Specific Power: 108 kWh/ton (Target: 95)</div>
                <div>• Power Factor: 0.92 (Target: 0.95)</div>
                <div>• Heat Recovery: 45% (Target: 60%)</div>
                <div>• Renewable Energy: 15% (Target: 25%)</div>
                <div style={{ color: '#74b9ff', marginTop: '4px' }}>Click to optimize energy usage</div>
              </div>
            )}
          </div>
        </Html>
      ...
      {/* Quality Control Indicator - Only show when details are visible */}
      {showDetails && (
        <Html position={[0, 8, 25]} center>
          <div 
            style={{
              background: hoveredCard === 'quality-control' ? 'rgba(16, 185, 129, 0.2)' : 'rgba(16, 185, 129, 0.1)',
              padding: '8px 12px',
              borderRadius: '8px',
              color: '#10b981',
              fontSize: '12px',
              fontWeight: 'bold',
              border: hoveredCard === 'quality-control' ? '2px solid rgba(16, 185, 129, 0.5)' : '1px solid rgba(16, 185, 129, 0.3)',
              textAlign: 'center',
              minWidth: '120px',
              cursor: 'pointer',
              transition: 'all 0.3s ease',
              transform: hoveredCard === 'quality-control' ? 'scale(1.05)' : 'scale(1)',
              boxShadow: hoveredCard === 'quality-control' ? '0 4px 12px rgba(16, 185, 129, 0.3)' : 'none'
            }}
            onMouseEnter={() => setHoveredCard('quality-control')}
            onMouseLeave={() => setHoveredCard(null)}
          >
            📊 Quality Control
            <div style={{ fontSize: '10px', opacity: 0.8, marginTop: '2px' }}>
              Index: 92.8 | Consistency: 95%
            </div>
            {hoveredCard === 'quality-control' && (
              <div style={{
                position: 'absolute',
                top: '100%',
                left: '50%',
                ...
                <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>📊 Quality Control Metrics</div>
                <div>• Quality Index: 92.8% (Target: 95%)</div>
                <div>• Blaine Fineness: 350 m²/kg (±15)</div>
                <div>• Free Lime: 1.8% (Target: 1.2%)</div>
                <div>• 28-day Strength: 45 MPa (±3)</div>
                <div>• Consistency: 95% (Target: 98%)</div>
                <div style={{ color: '#10b981', marginTop: '4px' }}>Click to optimize quality</div>
              </div>
            )}
          </div>
        </Html>
      ...
      {/* Carbon Footprint Indicator - Only show when details are visible */}
      {showDetails && (
        <Html position={[-25, 8, 15]} center>
          <div 
            style={{
              background: hoveredCard === 'carbon-footprint' ? 'rgba(231, 76, 60, 0.2)' : 'rgba(231, 76, 60, 0.1)',
              padding: '8px 12px',
              borderRadius: '8px',
              color: '#e74c3c',
              fontSize: '12px',
              fontWeight: 'bold',
              border: hoveredCard === 'carbon-footprint' ? '2px solid rgba(231, 76, 60, 0.5)' : '1px solid rgba(231, 76, 60, 0.3)',
              textAlign: 'center',
              minWidth: '120px',
              cursor: 'pointer',
              transition: 'all 0.3s ease',
              transform: hoveredCard === 'carbon-footprint' ? 'scale(1.05)' : 'scale(1)',
              boxShadow: hoveredCard === 'carbon-footprint' ? '0 4px 12px rgba(231, 76, 60, 0.3)' : 'none'
            }}
            onMouseEnter={() => setHoveredCard('carbon-footprint')}
            onMouseLeave={() => setHoveredCard(null)}
          >
            🌍 Carbon Footprint
            <div style={{ fontSize: '10px', opacity: 0.8, marginTop: '2px' }}>
              Current: 820 kg/ton | Target: 700
            </div>
            {hoveredCard === 'carbon-footprint' && (
              <div style={{
                position: 'absolute',
                top: '100%',
                left: '50%',
                ...
                <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>🌍 Carbon Footprint Analysis</div>
                <div>• CO₂ Emissions: 820 kg/ton (Target: 700)</div>
                <div>• NOx Emissions: 245 mg/Nm³ (Target: 200)</div>
                <div>• SO₂ Emissions: 25 mg/Nm³ (Target: 20)</div>
                <div>• Particulate: 45 mg/Nm³ (Target: 30)</div>
                <div>• Carbon Intensity: 0.92 (Target: 0.75)</div>
                <div style={{ color: '#e74c3c', marginTop: '4px' }}>Click to reduce emissions</div>
              </div>
            )}
          </div>
        </Html>
      ...
      {/* Waste Heat Recovery Indicator - Only show when details are visible */}
      {showDetails && (
        <Html position={[25, 8, 15]} center>
          <div 
            style={{
              background: hoveredCard === 'heat-recovery' ? 'rgba(243, 156, 18, 0.2)' : 'rgba(243, 156, 18, 0.1)',
              padding: '8px 12px',
              borderRadius: '8px',
              color: '#f39c12',
              fontSize: '12px',
              fontWeight: 'bold',
              border: hoveredCard === 'heat-recovery' ? '2px solid rgba(243, 156, 18, 0.5)' : '1px solid rgba(243, 156, 18, 0.3)',
              textAlign: 'center',
              minWidth: '120px',
              cursor: 'pointer',
              transition: 'all 0.3s ease',
              transform: hoveredCard === 'heat-recovery' ? 'scale(1.05)' : 'scale(1)',
              boxShadow: hoveredCard === 'heat-recovery' ? '0 4px 12px rgba(243, 156, 18, 0.3)' : 'none'
            }}
            onMouseEnter={() => setHoveredCard('heat-recovery')}
            onMouseLeave={() => setHoveredCard(null)}
          >
            🔥 Heat Recovery
            <div style={{ fontSize: '10px', opacity: 0.8, marginTop: '2px' }}>
            ...
            {hoveredCard === 'heat-recovery' && (
              <div style={{
                ...
                <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>🔥 Waste Heat Recovery System</div>
                <div>• Heat Recovery: 45% (Target: 60%)</div>
                <div>• Steam Generation: 8.5 t/h (Target: 12)</div>
                <div>• Power Generation: 2.1 MW (Target: 3.5)</div>
                <div>• Heat Exchanger Eff: 78% (Target: 85%)</div>
                <div>• Energy Savings: 15% (Target: 25%)</div>
                <div style={{ color: '#f39c12', marginTop: '4px' }}>Click to optimize heat recovery</div>
              </div>
            )}
          </div>
        </Html>
      ...
      {showOptimization && (
        <SustainabilityOptimization onClose={() => setShowOptimization(false)} />
      )}
    </>
  );
};
...
const CementPlant: React.FC<{ showDetails?: boolean; isWireframeMode: boolean }> = ({ showDetails = false, isWireframeMode }) => {
  ...
  return (
    <group ref={meshRef}>
      ...
      {/* Alternative Fuel Storage - Sustainable Optimization Feature */}
      <group position={[30, 0, -20]}>
        {/* RDF (Refuse Derived Fuel) Storage */}
        <Cylinder args={[3, 3, 10, 24]} position={[0, 5, 0]}>
          <meshStandardMaterial 
            color={isWireframeMode ? "#00b894" : "#e74c3c"}
            transparent
            opacity={isWireframeMode ? 0.4 : 0.8}
            emissive={isWireframeMode ? "#00b894" : "#c0392b"}
            emissiveIntensity={isWireframeMode ? 0.3 : 0.1}
            wireframe={isWireframeMode}
          />
        </Cylinder>
        ...
        {/* Biomass Storage */}
        <Cylinder args={[2.5, 2.5, 8, 24]} position={[8, 4, 0]}>
          <meshStandardMaterial 
            color={isWireframeMode ? "#00b894" : "#27ae60"}
            transparent
            opacity={isWireframeMode ? 0.4 : 0.8}
            emissive={isWireframeMode ? "#00b894" : "#229954"}
            emissiveIntensity={isWireframeMode ? 0.3 : 0.1}
            wireframe={isWireframeMode}
          />
        </Cylinder>
        ...
        <Cylinder args={[2, 2, 6, 24]} position={[-8, 3, 0]}>
          <meshStandardMaterial 
            color={isWireframeMode ? "#00b894" : "#f39c12"}
            transparent
            opacity={isWireframeMode ? 0.4 : 0.8}
            emissive={isWireframeMode ? "#00b894" : "#e67e22"}
            emissiveIntensity={isWireframeMode ? 0.3 : 0.1}
            wireframe={isWireframeMode}
          />
        </Cylinder>
        ...
        {/* Tire Chips Storage */}
        <Cylinder args={[1.5, 1.5, 4, 24]} position={[0, 2, 8]}>
          <meshStandardMaterial 
            color={isWireframeMode ? "#00b894" : "#8e44ad"}
            transparent
            opacity={isWireframeMode ? 0.4 : 0.8}
            emissive={isWireframeMode ? "#00b894" : "#7d3c98"}
            emissiveIntensity={isWireframeMode ? 0.3 : 0.1}
            wireframe={isWireframeMode}
          />
        </Cylinder>
        
        {/* Alternative Fuel Flow Lines */}
        <Line
          points={[
            [0, 5, 0],    // RDF Storage
            [20, 4, -8],  // Kiln
          ...
          color={isWireframeMode ? "#00b894" : "#e74c3c"}
          lineWidth={isWireframeMode ? 3 : 2}
        />
        
        <Line
          points={[
            [8, 4, 0],    // Biomass Storage
            [20, 4, -8],  // Kiln
          ]}
          color={isWireframeMode ? "#00b894" : "#27ae60"}
          lineWidth={isWireframeMode ? 3 : 2}
      ...
      {/* Waste Heat Recovery System - Sustainable Optimization Feature */}
      <group position={[25, 0, 20]}>
        {/* Heat Recovery Boiler */}
        <Box args={[6, 8, 4]} position={[0, 4, 0]}>
          <meshStandardMaterial 
            color={isWireframeMode ? "#f39c12" : "#e67e22"}
            transparent
            opacity={isWireframeMode ? 0.4 : 0.8}
            emissive={isWireframeMode ? "#f39c12" : "#d35400"}
            emissiveIntensity={isWireframeMode ? 0.3 : 0.1}
            wireframe={isWireframeMode}
          />
        </Box>
        ...
        {/* Steam Turbine */}
        <Cylinder args={[1.5, 1.5, 6, 16]} position={[8, 3, 0]}>
          <meshStandardMaterial 
            color={isWireframeMode ? "#f39c12" : "#3498db"}
            transparent
            opacity={isWireframeMode ? 0.4 : 0.8}
            emissive={isWireframeMode ? "#f39c12" : "#2980b9"}
            emissiveIntensity={isWireframeMode ? 0.3 : 0.1}
            wireframe={isWireframeMode}
          />
        </Cylinder>
        ...
        {/* Heat Exchanger */}
        <Box args={[4, 3, 3]} position={[-8, 1.5, 0]}>
          <meshStandardMaterial 
            color={isWireframeMode ? "#f39c12" : "#95a5a6"}
            transparent
            opacity={isWireframeMode ? 0.4 : 0.8}
            emissive={isWireframeMode ? "#f39c12" : "#7f8c8d"}
            emissiveIntensity={isWireframeMode ? 0.3 : 0.1}
            wireframe={isWireframeMode}
          />
        </Box>
        
        {/* Heat Recovery Flow Lines */}
        <Line
          points={[
            [20, 4, -8],  // Kiln exhaust
            [0, 4, 0],    // Heat Recovery Boiler
          ]}
          color={isWireframeMode ? "#f39c12" : "#e67e22"}
          lineWidth={isWireframeMode ? 3 : 2}
        />
        ...
        <Line
          points={[
            [0, 4, 0],    // Heat Recovery Boiler
            [-8, 1.5, 0], // Heat Exchanger
          ]}
          color={isWireframeMode ? "#f39c12" : "#95a5a6"}
          lineWidth={isWireframeMode ? 3 : 2}
        />
        
        {/* Waste Heat Recovery Labels */}
        {showDetails && (
          <>
            <Html position={[0, 10, 0]} center>
              <div style={{
  ...
  return (
    <CanvasContainer>
      ...
      />
        ...
        {/* Sustainable Optimization Features */}
        <SustainableFeatures showDetails={showDetails} />
